// From Google Web VR Experiments
// Function to add device orientation controls to the orbit controls. 
...
// Function should be imported in game.js and called before running
// any of the game.js code. 
export default orientationInit;
